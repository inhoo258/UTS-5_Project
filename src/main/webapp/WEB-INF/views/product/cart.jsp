				...
				<table class="detail_table">
					...
					<tr class="th">
						<th id="thSelect" style="width: 130px; text-align: left;"><input
							...
							<label for="ico_check" class="bb"></label> <label for="ico_check"
							class="cc"></label> <span id="span_allCheck"> 전체선택</span></th>
					...
					<c:forEach var="cart" items="${cartList}">
						<tr>
							<td style="padding-left: 20px;"><input type="checkbox"
								class="ico_check"><input type="hidden" class="hidden_product_id" name="product_id"
			...
			<div>
				<div class="cart_result">
					...
					<div class="list delivery">
						...
						<span class="deliveryPrice">3,000원</span>
						<div class="delPriceCheck">
							<label class="deliveryLimit">${50000-totalPrice}</label>원 추가주문 시,
							무료배송
						</div>
						<span class="delPriceOk"> 0원 </span>
					</div>
					<div class="deco_equal">
						<i class="fas fa-equals"></i>
					</div>
					<div class="list total_price">
						<div class="tit">결제 예정 금액</div>
						<span class="finalPrice"></span><span>원</span>
					</div>
				</div>
	...
	<script type="text/javascript">
		...
		$(".btn_reduce").click(
						function() {
							...
							console.log($(".cart_product_price").get(idx).innerText);
